...
- [ ] **Cell 1 – Header Comment**  
  ...
  *Example:*
  ...
  # DATASET: data/comprehensive_loan_data.csv
...
- [ ] **Cell 3 – Data Load**  
  ...
  ```python
  RANDOM_STATE = 42
  DATA_PATH = "data/comprehensive_loan_data.csv"
...
applied to comprehensive_loan_data.csv.
...
comprehensive_loan_data.csv), preprocessing pipeline, 10–12 high-impact EDA visualizations 
